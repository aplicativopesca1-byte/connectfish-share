...
async function ensurePersistence() {
  // ✅ garante que a sessão vai persistir entre rotas/reloads
  try {
    await setPersistence(auth, browserLocalPersistence);
  } catch (err) {
    // não bloqueia login por causa disso, mas loga pra debug
...
export default function LoginPage() {
  ...
  const primaryAction = mode === "login" ? doLogin : mode === "register" ? doRegister : doReset;
